...
static USBH_StatusTypeDef USBH_HID_Keyboard_InterfaceInit  (USBH_HandleTypeDef *phost);
static USBH_StatusTypeDef USBH_HID_Mouse_InterfaceInit  (USBH_HandleTypeDef *phost);
static USBH_StatusTypeDef USBH_HID_Common_InterfaceInit  (USBH_HandleTypeDef *phost);
static USBH_StatusTypeDef USBH_HID_InterfaceInit  (USBH_HandleTypeDef *phost, uint8_t protocol);
...
USBH_ClassTypeDef  HID_Class_Keyboard =
{
  "HID",
  USB_HID_CLASS,
  USBH_HID_Keyboard_InterfaceInit,
  USBH_HID_InterfaceDeInit,
  USBH_HID_ClassRequest,
  USBH_HID_Process,
  USBH_HID_SOFProcess,
...
USBH_ClassTypeDef  HID_Class_Mouse =
{
  "HID",
  USB_HID_CLASS,
  USBH_HID_Mouse_InterfaceInit,
  USBH_HID_InterfaceDeInit,
  USBH_HID_ClassRequest,
  USBH_HID_Process,
  USBH_HID_SOFProcess,
...
static USBH_StatusTypeDef USBH_HID_Keyboard_InterfaceInit  (USBH_HandleTypeDef *phost) {
  return USBH_HID_InterfaceInit(phost, HID_KEYBRD_BOOT_CODE);
}
static USBH_StatusTypeDef USBH_HID_Mouse_InterfaceInit  (USBH_HandleTypeDef *phost) {
  return USBH_HID_InterfaceInit(phost, HID_MOUSE_BOOT_CODE);
}
static USBH_StatusTypeDef USBH_HID_Common_InterfaceInit  (USBH_HandleTypeDef *phost) {
  return USBH_HID_InterfaceInit(phost, 0xFFU);
}
static USBH_StatusTypeDef USBH_HID_InterfaceInit (USBH_HandleTypeDef *phost, uint8_t protocol)
{
  uint8_t max_ep;
